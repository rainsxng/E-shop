            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                                href="/category/<?= $product->getCategoryId(); ?>"><?= $product->getCategory(); ?></a>
                        / <?= $product->getBrand() . ' ' . $product->getName(); ?></li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="col">
                            <?php if ($product->getQuantity() >= 1) { ?>
                                <div class="form-group">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col">
                                            <button type="button" class="btn btn-primary align-self-center mt-2"
                                                    onclick="AjaxAddToCart(<?= $product->getId(); ?>)">Купить
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
           aria-controls="pills-home" aria-selected="true">Характеристики</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
           aria-controls="pills-profile" aria-selected="false">Отзывы(<span id="count"> <?= $count; ?></span>)</a>
    </li>
</ul>
<div class="tab-content" id="pills-tabContent">
    <div class="tab-pane fade show active ml-5" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        <table class="table">
            <thead>
            <tr>
            ...
            <div class="col-md-6 col-md-offset-2 col-sm-12">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-info pull-right"
                            onclick="AddComment(<?= $product->getId(); ?>,<?= $_SESSION['user_id']; ?>)">Добавить
                    </button>
