        ...
        <div class="col-12 col-sm-3">
            <div class="card bg-light mb-3">
                ...
                <ul class="list-group category_block">
                    <li class="list-group-item"><a href="../category/category.php">Наушники</a></li>
                    <li class="list-group-item"><a href="../category/category.php">Lorem ipsum dolor sit amet.</a></li>
                    <li class="list-group-item"><a href="../category/category.php">Lorem ipsum dolor sit amet.</a></li>
                    <li class="list-group-item"><a href="../category/category.php">PLorem ipsum dolor sit amet.</a></li>
                    <li class="list-group-item"><a href="../category/category.php">Lorem ipsum dolor sit amet.</a></li>
                </ul>
            </div>
            <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                    <img class="img-fluid" src="<?=$items[1]['img'];?>" />
...
<!-- Footer -->
<?php include_once '/home/NIX/phpstudent/www/app/views/footer/footer.html';?>
