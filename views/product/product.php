...
<body>
<?php
include "/home/NIX/phpstudent/www/app/views/header/header.html";
...
<div class="container-flued">
    <div class="row mr-4">
        <div class="col-md-4">
            <img src="<?=$item[$key]['img'];?>" alt="Product photo" height="450px">
        ...
        <div class="col">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col align-self-center">
                            <div class="description"><?=$item[$key]['text'];?></div>
                        </div>
                    </div>
